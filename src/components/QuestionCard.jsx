...
const QuestionCard = ({ questionData, onAnswer, onNext, inputMode }) => {
    ...
    return (
        <div className="w-full max-w-4xl mx-auto p-4 z-20 relative flex flex-col justify-center min-h-[60vh]">
            <div className="bg-zinc-900/90 border-t-2 border-b-2 border-st-red p-8 md:p-12 rounded-sm shadow-[0_0_40px_rgba(0,0,0,0.8)] backdrop-blur-sm">
                            ...
                            <div className="text-center">
                                ...
                                {isFuzzyMatch(inputValue, questionData.answer) ? (
                                    <div className="mb-6">
                                        ...
                                        <div className="text-zinc-400">Вы ответили: {inputValue}</div>
                                    </div>
                                ) : (
                                    <div className="mb-6">
